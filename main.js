...
mobile: MethodMobile, 
browser: opcion == '1' ? ['ATRO-BOT-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['ATRO-BOT-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
conn.fakeReply('51935531943@s.whatsapp.net', '🚀🟢 Estoy Activo!', '0@s.whatsapp.net', '🎈 Estoy Conectado!', '0@s.whatsapp.net')
...
setInterval(async () => {
  ...
  const bio = `🌹 Soy Tu Bot Atro! 👨‍💻Activo Durante: ${uptime}`;

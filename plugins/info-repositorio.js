...
const handler = async (m, { conn, args, usedPrefix }) => {
   const res = await fetch('https://api.github.com/repos/Edwardofc/ATRO-BOT-MD');
   const json = await res.json();
   let txt = `_*< INFO - REPOSITORIO />*_\n\n`;
      txt += `▢ *Nombre:* ${json?.name || 'ATRO-BOT-MD'}\n\n`;
